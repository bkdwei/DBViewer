...
public class UI {
	...
	public JTextField tfSqlCommand;
	public JButton btExecuteSql;
	public JButton  btQueryAllData = new JButton("收集所有数据");
	...
	public void init() {
		...
		tfSqlCommand = new JTextField("请输入您要执行的命令", 50);
		btExecuteSql = new JButton("执行");
